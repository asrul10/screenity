$(document).ready(function () {
  ...
  function injectCode(inject, active) {
    if (inject) {
      ...
      // Inject the iframe
      var iframeinject =
        "<div id='canvas-cont'><canvas id='canvas-draw'></canvas></div><div id='click-highlight'></div><div id='detect-iframe'><div id='hide-camera' class='camera-hidden'><img src='" +
        chrome.extension.getURL("./assets/images/close.svg") +
        "' class='noselect'></div><div id='change-size' class='camera-hidden'><div id='small-size' class='size-active choose-size'></div><div id='medium-size' class='choose-size'></div><div id='large-size' class='choose-size'></div></div></div><div id='wrap-iframe' class='notransition'><iframe src='" +
      ...
      var toolbarinject =
        ...
        "'/></div><div id='cursor' class='tool' title='Cursor settings'><img src='" +
  ...
  function hideTools() {
    if (!persistent) {
      ...
      $("#" + uniqueid + " #toolbar-record-cursor").addClass(
        "toolbar-inactive"
      );
  ...
  function pauseRecording() {
    ...
    $("#" + uniqueid + " #toolbar-record-pen #pen-tool").removeClass(
      "tool-active"
    );
    $("#" + uniqueid + " #toolbar-record-pen #eraser").removeClass(
      "tool-active"
    );
    $("#" + uniqueid + " #toolbar-record-pen #text").removeClass("tool-active");
    $("#" + uniqueid + " #toolbar-record #arrow").removeClass("tool-active");
    $("#" + uniqueid + " #toolbar-record-cursor #click-tool").removeClass(
      "tool-active"
    );
    $("#" + uniqueid + " #toolbar-record-cursor #focus-tool").removeClass(
      "tool-active"
    );
    $("#" + uniqueid + " #toolbar-record-cursor #hide-cursor-tool").removeClass(
      "tool-active"
    );
    ...
    $("#" + uniqueid + " #click-tool img").attr(
      "src",
      chrome.extension.getURL("./assets/images/click.svg")
    );
    $("#" + uniqueid + " #focus-tool img").attr(
      "src",
      chrome.extension.getURL("./assets/images/focus.svg")
    );
    $("#" + uniqueid + " #hide-cursor-tool img").attr(
      "src",
      chrome.extension.getURL("./assets/images/hide-cursor.svg")
    );
    ctx_focus.clearRect(0, 0, canvas_focus.width, canvas_focus.height);
  ...
  $(document).on("click", "#" + uniqueid + " #tab-audio", function () {
    if (tabaudioon) {
      ...
      $("#" + uniqueid + " #tab-audio img").attr(
        "src",
        chrome.extension.getURL("./assets/images/tab-audio.svg")
      );
  ...
  $(document).on("mouseover", "#" + uniqueid + " #toolbar-record", function () {
    if (!mousedown) {
      ...
      if ($("#" + uniqueid + " #pen").hasClass("pen-options")) {
        $("#" + uniqueid + " #toolbar-record-pen").removeClass(
          "toolbar-inactive"
        );
      } else if ($("#" + uniqueid + " #settings").hasClass("pen-options")) {
        $("#" + uniqueid + " #toolbar-settings").removeClass(
          "toolbar-inactive"
        );
      } else if ($("#" + uniqueid + " #cursor").hasClass("pen-options")) {
        $("#" + uniqueid + " #toolbar-record-cursor").removeClass(
          "toolbar-inactive"
        );
      }
    }
  ...
  $(document).on(
    "click",
    "#" + uniqueid + " #toolbar-record #settings",
    function () {
      if (
        $("#" + uniqueid + " #toolbar-record #settings").hasClass("pen-options")
      ) {
        moretools = false;
        $("#" + uniqueid + " #toolbar-record #settings").removeClass(
          "pen-options"
        );
        $("#" + uniqueid + " #toolbar-record #settings img").attr(
          "src",
        ...
        if (arrowon || texton || drawing) {
          ...
          $("#" + uniqueid + " #toolbar-record #pen img").attr(
            "src",
        ...
        $("#" + uniqueid + " #toolbar-record #cursor img").attr(
          "src",
          chrome.extension.getURL("./assets/images/cursor.svg")
        );
        $("#" + uniqueid + " #toolbar-record-cursor").addClass(
        ...
        $("#" + uniqueid + " #toolbar-record-pen").addClass("toolbar-inactive");
        $("#" + uniqueid + " #toolbar-record #settings").addClass(
          "pen-options"
        );
        $("#" + uniqueid + " #toolbar-record #settings img").attr(
          "src",
  ...
  $(document).on(
    "click",
    "#" + uniqueid + " #toolbar-record #pen",
    function () {
      if (recording) {
        if (
          $("#" + uniqueid + " #toolbar-record #pen").hasClass("pen-options")
        ) {
          moretools = false;
          $("#" + uniqueid + " #toolbar-record #pen").removeClass(
            "pen-options"
          );
          $("#" + uniqueid + " #toolbar-record-pen").addClass(
            "toolbar-inactive"
          );
          if (arrowon || texton || drawing) {
            $("#" + uniqueid + " #toolbar-record #pen").addClass("tool-active");
  ...
  $(document).on(
    "click",
    "#" + uniqueid + " #toolbar-record #cursor",
    function () {
      if (recording) {
        if (
          $("#" + uniqueid + " #toolbar-record #cursor").hasClass("pen-options")
        ) {
          moretools = false;
          $("#" + uniqueid + " #toolbar-record #cursor").removeClass(
            "pen-options"
  ...
  $(document).on("click", "#" + uniqueid + " #eraser", function () {
    if ($("#" + uniqueid + " #eraser").hasClass("tool-active")) {
      ...
      $("#" + uniqueid + " #eraser img").attr(
        "src",
        chrome.extension.getURL("./assets/images/eraseractive.svg")
      );
    }
  });
  ...
  $(document).on("click", "#" + uniqueid + " #focus-tool", function (e) {
    if (focuson) {
      ...
      $("#" + uniqueid + " #focus-tool img").attr(
        "src",
        chrome.extension.getURL("./assets/images/focusactive.svg")
      );
    }
  });
